...
import com.groupfive.sketchmatch.viewmodels.LobbyViewModel
import androidx.lifecycle.viewmodel.compose.viewModel


@Composable
fun WaitingLobby(modifier: Modifier = Modifier,
...
fun WaitingLobbyPreview() {
    SketchmatchTheme {
        //WaitingLobby(modifier = Modifier, navController = rememberNavController())
    }
}
